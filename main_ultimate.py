...
<head>
    ...
    <title>Mon Panier Ultimate</title>
    <style>
        ...
        .btn-toggle { position: fixed; top: 15px; right: 15px; z-index: 1000; border-radius: 50%; width: 40px; height: 40px; border: 2px solid #38bdf8; background: var(--card); color: #38bdf8; }
...
<body class="dark-theme">
    ...
    <div class="container py-3">
        <h2 class="text-center mb-4 no-print">🛒 MON PANIER ULTIMATE</h2>
            ...
            <div class="col-md-7">
                <div class="card text-center">
                    ...
                    <div class="mt-3 d-flex flex-wrap gap-2 no-print">
                        <button onclick="copyToWhatsapp()" class="btn btn-success flex-grow-1">WhatsApp</button>
                        <button onclick="window.print()" class="btn btn-outline-info">Imprimer</button>
                        <a href="/cloturer" class="btn btn-primary fw-bold" onclick="return confirm('Vider et enregistrer ?')">🏁 FINIR</a>
                    </div>
                </div>

                <div class="mb-3 no-print">
                    <form action="/" method="GET" class="d-flex gap-2">
                        <input type="text" name="q" class="form-control" placeholder="Chercher un produit dans la liste..." value="{{ query }}">
    ...
    <script>
        ...
        function copyToWhatsapp() {
            ...
            texte += "\\n*💰 TOTAL : " + document.querySelector('.total-display').innerText + "*";
...
def home():
    ...
    return render_template_string(HTML_PAGE, liste=liste, total=total_p, progression=prog, favoris=favs, stats=stats, query=query, categories=list(CAT_CONFIG.keys()), config=CAT_CONFIG)
