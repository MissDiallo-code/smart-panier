...
<body>
    <div class="container" style="max-width: 980px;">
        ...
        <div class="budget-alert-banner shadow-lg">
            🚨 ATTENTION : Budget dépassé de {{ "%.0f"|format(total - budget) }} {{ devise }} ! 🚨
        </div>
        {% endif %}
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-7">
                ...
                <div class="card no-print mb-3 py-2">
                    <input type="text" id="searchInput" oninput="filterItems()" class="form-control mb-2" placeholder="🔍 Rechercher dans mon panier...">
